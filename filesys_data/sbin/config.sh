...
CONFIG_IP6_NF_MATCH_IPV6RANGE=y
...
CONFIG_MT_SMART_CARRIER_SENSE_SUPPORT=y
CONFIG_MT_ATE_SUPPORT=y
CONFIG_MT_SINGLE_SKU=y
CONFIG_MT_UAPSD=y

CONFIG_MT_WIFI_MODE_AP=y
CONFIG_MT_AP_SUPPORT=y
CONFIG_MT_MBSS_SUPPORT=y
CONFIG_MT_APCLI_SUPPORT=y
CONFIG_MT_APCLI_CERT_SUPPORT=y
CONFIG_MT_MAC_REPEATER_SUPPORT=y
CONFIG_MT_DOT11R_FT_SUPPORT=y
CONFIG_MT_DOT11K_RRM_SUPPORT=y
CONFIG_MT_MAC=y
CONFIG_RTDEV=y
...
CONFIG_USER_DHCP6=y
CONFIG_USER_DHCP6_SERVER=y
CONFIG_USER_DHCP6_CLIENT=y
...
CONFIG_LIB_ZLIB_FORCE=y
CONFIG_USER_HTTPD=y
CONFIG_USER_SHARED=y
CONFIG_USER_RC=y
CONFIG_USER_IGMP_PROXY=y
CONFIG_USER_IGMP_X_MLD=y
CONFIG_USER_CRON=y
CONFIG_USER_CESMDNS=y
CONFIG_USER_TRACEROUTE=y
CONFIG_USER_IPUTILS=y
CONFIG_USER_IPTABLES_IPTABLES=y
CONFIG_LIB_LIBM_FORCE=y
CONFIG_USER_IPTABLES_IP6TABLES=y
CONFIG_USER_IPROUTE2=y
CONFIG_USER_IPROUTE2_SS=y
CONFIG_USER_IPROUTE2_ARPD=y
CONFIG_USER_IPROUTE2_NSTAT=y
CONFIG_USER_IPROUTE2_IFSTAT=y
CONFIG_USER_IPROUTE2_RTACCT=y
CONFIG_USER_IPROUTE2_LNSTAT=y
CONFIG_USER_IPROUTE2_IP=y
CONFIG_USER_IPROUTE2_RTMON=y
...
CONFIG_CBTINFO_TOOL=y
CONFIG_CBTAPP=y
CONFIG_CBTAPP_CBTINFO=y
CONFIG_USER_CBT_MFT=y
CONFIG_USER_CURL=y
CONFIG_USER_GPG=y
