...
new Array(
new Array(wlantopmenu.basicset,   "../Wireless_WSC.asp",   "<% get_lang(); %>_help/Basic_Wireless_Settings.asp",bmenu.wireless),
...
new Array
(
new Array(pctrl.pcontrol,"../PC_Filter.asp","<% get_lang(); %>_help/Internet_Access_Policy.asp",newui.policy)
),
new Array
(
