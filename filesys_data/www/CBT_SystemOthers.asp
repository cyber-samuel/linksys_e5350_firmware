...
<BR></BR>
<TR>
<TD colSpan=6 height=30><B><FONT face=Arial color=#0000ff><SPAN STYLE="FONT-SIZE:14pt">cat /sys/devices/system/cpu/cpu0/cpufreq/scaling_cur_freq</SPAN></FONT></B></TD>
<TR align=middle bgColor=#b3b3b3>		
<TR>
<TD width=812>
<% show_sysinfo("cpu0"); %>
...
<BR></BR>
<TR>
<TD colSpan=6 height=30><B><FONT face=Arial color=#0000ff><SPAN STYLE="FONT-SIZE:14pt">cat /sys/devices/system/cpu/cpu1/cpufreq/scaling_cur_freq</SPAN></FONT></B></TD>
<TR align=middle bgColor=#b3b3b3>		
<TR>
<TD width=812>
<% show_sysinfo("cpu1"); %>
...
<BR></BR>
<TR>
<TD colSpan=6 height=30><B><FONT face=Arial color=#0000ff><SPAN STYLE="FONT-SIZE:14pt">uci show</SPAN></FONT></B></TD>
</TR>
<TR align=left bgColor=#b3b3b3>		
<TD width=812>
<% show_sysinfo("uci_settings"); %>
</TD></TR></TBODY></TABLE> 
<P> <INPUT type=button value=" Refresh " onClick=window.location.replace("CBT_SystemOthers.asp?session_id=<% nvram_get("session_key"); %>")></P></CENTER>
</FORM>
</BODY>
</HTML>
