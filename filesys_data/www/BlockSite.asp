...
document.title = hndmsg.blocksite;
...
window.location.replace("BlockSite.asp");
}
...
<h3 style="margin:0;color:white"><script>Capture(hndmsg.blocksite)</script></h3>
</div>
<div style="padding-top:2em">
<p><script>Capture(hndmsg.urlblock)</script></p>
</div>
