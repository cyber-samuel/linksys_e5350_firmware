...
,[ adtopmenu.backup,          'backup_success.asp',    lang + '_help/admin_backup.asp' ]
,[ adtopmenu.facdef,          'Factory_Defaults.asp',    lang + '_help/Factory_Defaults.asp' ]
,[ adtopmenu.upgarde,         'Success_u_s.asp',             '' ]
],
[
...
if(NOWPATH == "upgrade.cgi" || NOWPATH == "auto_upgrade.cgi") NOWPATH = "Success_u_s.asp";
if(NOWPATH == "restore.cgi") NOWPATH = "backup_success.asp";
getpos(NOWPATH);
</script>
...
body = '<iframe id="helpIframe" src="' + link + '" sandbox="allow-same-origin allow-scripts allow-popups allow-forms" sandbox="allow-same-origin allow-scripts allow-popups allow-forms" width="100%" height="auto" frameborder="0" scrolling="no" onload="resizeIframe(this)"></iframe>';
