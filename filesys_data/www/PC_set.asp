...
setFormActions({
'wlanwscpopup.button':    'javascript:to_submit(document.PC_set_passwd)',
...
<tbody>
<tr>
<td colspan="2"><script>Capture(pctrl.pwdinfo)</script></td>
</tr>
<tr>
...
<tbody>
<tr>
<td colspan="2"><script>Capture(pctrl.qainfo)</script></td>
</tr>
<tr>
<td><script>Capture(pctrl.sqst)</script>:</td>
<td>
<input maxlength="64" style="width:180px" name="hnd_question" />
</td>
</tr>
<tr>
<td><script>Capture(pctrl.asw)</script>:</td>
<td>
<input maxlength="32" style="width:180px" name="hnd_answer" />
</td>
</tr>
<tr>
<td>&nbsp;</td>
