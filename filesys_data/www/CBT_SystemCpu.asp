...
<CENTER>
<TABLE cellSpacing=0 cellPadding=10 width=673 border=1>
<TBODY>
<BR></BR>
<TR>
<TD colSpan=6 height=30><B><FONT face=Arial color=#0000ff><SPAN STYLE="FONT-SIZE:14pt">Cpu Usage</SPAN></FONT></B></TD>
...
<p></p>
<P> <INPUT type=button value=" Refresh " onClick=window.location.replace("CBT_SystemCpu.asp?session_id=<% nvram_get("session_key"); %>")></P></CENTER>
</FORM>
</BODY>
</HTML>
