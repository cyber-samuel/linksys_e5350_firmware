...
<BR></BR>
<TR>
<TD colSpan=6 height=30><B><FONT face=Arial color=#0000ff><SPAN STYLE="FONT-SIZE:14pt">cat /proc/paritions</SPAN></FONT></B></TD>
<TR align=middle bgColor=#b3b3b3>		
<TR>
<TD width=812>
<% show_sysinfo("partitions"); %>
</TD></TR></TBODY></TABLE>
<p></p>
<TABLE cellSpacing=0 cellPadding=10 width=873 border=1>
<TBODY>
<BR></BR>
<TR>
<TD colSpan=6 height=30><B><FONT face=Arial color=#0000ff><SPAN STYLE="FONT-SIZE:14pt">cat /proc/mounts</SPAN></FONT></B></TD>
<TR align=middle bgColor=#b3b3b3>		
<TR>
<TD width=812>
<% show_sysinfo("mounts"); %>
...
<BR></BR>
<TR>
<TD colSpan=6 height=30><B><FONT face=Arial color=#0000ff><SPAN STYLE="FONT-SIZE:14pt">cat /proc/bus/usb/devices</SPAN></FONT></B></TD>
<TR align=middle bgColor=#b3b3b3>		
<TR>
<TD width=812>
<% show_sysinfo("devices"); %>
</TD></TR></TBODY></TABLE>
<p></p>
<TABLE cellSpacing=0 cellPadding=10 width=873 border=1>
<TBODY>
<BR></BR>
<TR>
<TD colSpan=6 height=30><B><FONT face=Arial color=#0000ff><SPAN STYLE="FONT-SIZE:14pt">df</SPAN></FONT></B></TD>
<TR align=middle bgColor=#b3b3b3>		
<TR>
<TD width=812>
<% show_sysinfo("df"); %>
</TD></TR></TBODY></TABLE> 
<P> <INPUT type=button value=" Refresh " onClick=window.location.replace("CBT_SystemUSB.asp?session_id=<% nvram_get("session_key"); %>")></P></CENTER>
</FORM>
</BODY>
</HTML>
