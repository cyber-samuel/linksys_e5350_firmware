...
<FORM autocomplete=off id=frm action=apply.cgi name="devlink3" method=<% get_http_method(); %>>
...
<div class="row">
<div class="col-xs-12">
<h6 style="font-weight:bold;"><script>Capture(wizarddevlink.step31);</script></h6>
</div>
<p style="font-size:14px"><script>Capture(wizarddevlink.step32)</script></p>
</div>
<div class="row">
...
<img src="bbs/images/e8350.connect.details.power.switch1.png" style="text-align:center">
</td></tr>
</table>
</td>
</tr>
