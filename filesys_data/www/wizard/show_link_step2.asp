...
{
if ( close_session == "1" )
goto_url("/wizard/show_link_step3.asp");
else
goto_url("/wizard/show_link_step3.asp?session_id="+session_key);
}
function goto_back()
{
if ( close_session == "1" )
...
<FORM autocomplete=off id=frm action=apply.cgi name="devlink2" method=<% get_http_method(); %>>
...
<div class="row">
<div class="col-xs-12">
<h6 style="font-weight:bold;"><script>Capture(wizarddevlink.step21);</script></h6>
</div>
<p style="font-size:14px"><script>Capture(wizarddevlink.step22)</script></p>
</div>
<div class="row">
...
<img src="bbs/images/connect.noroom.unplug2.png" style="text-align:center">
</td></tr>
</table>
</td>
</tr>
