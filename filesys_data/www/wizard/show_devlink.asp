...
<div id="waiting_box" class="large reveal-modal">
<h1><script>Capture(wizardBasic.E8400_setup_wizard)</script></h1>
<p class="waiting"><img width="28" src="bbs/images/loading.gif" alt="Loading"> <script>Capture(str_cgi_loading.detectwan)</script></p>
</div>
<!-- Header -->
<!--<div id="header" >-->
...
{
if ( close_session == "1" )
goto_url("/wizard/index.asp");
else
goto_url("/wizard/index.asp?session_id="+session_key);
}
function goto_showmehow()
{
if ( close_session == "1" )
goto_url("/wizard/show_link_step2.asp");
else
goto_url("/wizard/show_link_step2.asp?session_id="+session_key);
}
</script>
<!-- InstanceEndEditable -->
<!-- InstanceBeginEditable name="Main Content" -->
<FORM autocomplete=off id=frm action=apply.cgi name="show_devlink" method=<% get_http_method(); %>>
...
<div class="row">
<div class="col-xs-12">
<h6 style="font-weight:bold;"><script>Capture(wizarddevlink.connect);</script></h6>
</div>
</div>
<div class="row">
<div class="twelve columns" style="padding-top:10px;text-align:left">
...
<td width=220 ><table  style="width:100%;border-width:0px;margin:0 0 5px;">
<!--	<tr style="background-color:#ffffff"><td>&nbsp;</td></tr>-->
<tr style="background-color:#ffffff"><td style="padding-top:0px">
<img src="bbs/images/step1.png"></td>
<td style="padding-top:0px">
<script>Capture(wizarddevlink.linkpower1);</script>
</td></tr>	
<!--
<tr></td></td></tr>	
<tr style="background-color:#ffffff"><td style="padding-top:0px">
<script>Capture(wizarddevlink.linkpower2);</script>
</td></tr>	
<tr style="background-color:#ffffff"><td style="padding-top:0px">
<img src="bbs/images/e8350.connect.details.power.switch.png" style="text-align:center">
</td></tr>
-->
</table>
</td>
<td>
<img src="bbs/images/e8350.connect.verticalbar.png" style="text-align:center">
</td>
<td><table  style="width:100%;border-width:0px;margin:0 0 5px;">
<!--	<tr style="background-color:#ffffff"><td>&nbsp;</td></tr>-->
<tr style="background-color:#ffffff">
<td style="padding-top:0px">
<img src="bbs/images/step2.png"></td>
<td style="padding-top:0px">
<script>Capture(wizarddevlink.linkdev1);</script>
</td></tr>	
<tr style="background-color:#ffffff">
<td></td>	
<td style="padding-top:0px">
<img src="bbs/images/e8350.connect.attachwan.router.png" style="text-align:center">
<button type=button class=wpr-layout-pageaction-button style="background-color:orange;color:white" onclick=javascript:goto_showmehow()><script>Capture(wizardBasic.showmehow);</script></button>
</td></tr>
</table></td>
</tr>
</table>
