...
<title>Show device link 1</title>
<!-- InstanceEndEditable -->
...
<FORM autocomplete=off id=frm action=apply.cgi name="devlink1" method=<% get_http_method(); %>>
<input type="hidden" name="submit_button" value="">
<input type="hidden" name="wizard_status" value="">
...
<div class="row">
<div class="col-xs-12">
<h6 style="font-weight:bold;"><script>Capture(wizarddevlink.step11);</script></h6>
</div>
<p style="font-size:14px"><script>Capture(wizarddevlink.step12)</script></p>
</div>
<div class="row">
...
<b><script>Capture(wizarddevlink.step11);</script></b>
</td></tr>	
<tr style="background-color:#ffffff"><td>
<script>Capture(wizarddevlink.step12);</script>
</td></tr>-->
<!--	<tr style="background-color:#ffffff"><td style="height:10px;">&nbsp;</td></tr> -->
<!--	<tr style="background-color:#ffffff;font-size:12px;"><td>
<script>Capture(wizardBasic.msg3)</script>
</td></tr>
-->
<tr>
...
<img src="bbs/images/connect.wired.frompc.png" style="text-align:center">
</td></tr>
</table>
</td>
</tr>
...
<script>
document.write("<button type=button class=wpr-layout-pageaction-button style=\"width:100px;background-color:gray\" onclick=\"javascript:goto_back()\" id=t3 >");
