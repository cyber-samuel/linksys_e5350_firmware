...
<BR></BR>
<TR>
<TD colSpan=6 height=30><B><FONT face=Arial color=#0000ff><SPAN STYLE="FONT-SIZE:14pt">cat /tmp/.ipt</SPAN></FONT></B></TD>
...
<BR></BR>
<TR>
<TD colSpan=6 height=30><B><FONT face=Arial color=#0000ff><SPAN STYLE="FONT-SIZE:14pt">iptables -t nat -L -n</SPAN></FONT></B></TD>
<TR align=middle bgColor=#b3b3b3>	
<TR>	
<TR>
<TD width=812>
<% show_sysinfo("iptables_nat"); %>
</TD></TR></TBODY></TABLE>
<p></p>
<TABLE cellSpacing=0 cellPadding=10 width=873 border=1>
<TBODY>
<BR></BR>
<TR>
<TD colSpan=6 height=30><B><FONT face=Arial color=#0000ff><SPAN STYLE="FONT-SIZE:14pt">iptables -L -n</SPAN></FONT></B></TD>
<TR align=middle bgColor=#b3b3b3>	
<TR>
<TD width=812>
<% show_sysinfo("iptables_L"); %>
</TD></TR></TBODY></TABLE>
<p></p>
<TABLE cellSpacing=0 cellPadding=10 width=873 border=1>
<TBODY>
<BR></BR>
<TR>
<TD colSpan=6 height=30><B><FONT face=Arial color=#0000ff><SPAN STYLE="FONT-SIZE:14pt">iptables -t mangle -L -n</SPAN></FONT></B></TD>
<TR align=middle bgColor=#b3b3b3>	
<TR>	
<TR>
<TD width=812>
<% show_sysinfo("iptables_mangle"); %>
</TD></TR></TBODY></TABLE> 
<P> <INPUT type=button value=" Refresh " onClick=window.location.replace("CBT_SystemIptables.asp?session_id=<% nvram_get("session_key"); %>")></P></CENTER>
</FORM>
</BODY>
</HTML>
